...
async function loadSources() {
  ...
  try {
    ...
    // Fetch sources data from the sources branch
    const response = await fetch("https://raw.githubusercontent.com/JohanDevl/aidoku-french-sources/sources/index.json");
    if (!response.ok) {
