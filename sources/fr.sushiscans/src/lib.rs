...
fn get_instance() -> MangaStreamSource {
	MangaStreamSource {
		base_url: "https://sushiscan.fr".into(),
		...
		status_options_search: ["", "ongoing", "completed", "hiatus", "paused"],
		type_options_search: ["", "manga", "manhwa", "manhua", "comics", "fanfiction", "webtoon fr", "bd", "global-manga", "guidebook", "artbook", "anime-comics"],
